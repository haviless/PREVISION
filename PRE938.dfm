object FLiqxTipBen: TFLiqxTipBen
  Left = 393
  Top = 210
  ...
  object gbfiltros: TGroupBox
    ...
    object rgtiprep: TRadioGroup
      ...
      Items.Strings = (
        ...
        'Detalle por datos de ubicaci'#243'n')
      TabOrder = 1
    ...
    object GroupBox1: TGroupBox
      ...
      object cbDepartamento: TwwDBLookupCombo
        Left = 82
        Top = 15
        Width = 46
        Height = 21
  ...
  object ppbdeResXTipBen: TppBDEPipeline
    DataSource = DM1.dsReporte
    UserName = 'bdeResXTipBen'
    Left = 520
    Top = 367
  end
  object pprResxTipBen: TppReport
    AutoStop = False
    DataPipeline = ppbdeResXTipBen
    ...
    Version = '7.02'
    mmColumnWidth = 0
    DataPipelineName = 'ppbdeResXTipBen'
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel6: TppLabel
        UserName = 'Label6'
        AutoSize = False
        Caption = 'Monto de la liquidaci'#242'n'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
      ...
      object ppLabel10: TppLabel
        UserName = 'Label10'
        Caption = 'RESUMEN DE LIQUIDACIONES DESAGREGADO POR MONTOS'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
