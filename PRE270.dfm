object FLibAhoMod: TFLibAhoMod
  ...
  object gbdatliq: TGroupBox
    ...
    object pnlpvslfecbe: TPanel
      Left = 248
      Top = 44
      Width = 107
      Height = 23
      TabOrder = 1
      object dbdtppvslfecbe: TwwDBDateTimePicker
        Left = 1
        Top = 1
        Width = 105
        Height = 21
    ...
    object pnlmonliq: TPanel
      Left = 435
      Top = 44
      Width = 83
      Height = 23
      TabOrder = 2
      object memonliq: TMaskEdit
        Left = 1
        Top = 1
        Width = 81
        Height = 21
    ...
    object pnlasoapepatdni: TPanel
      Left = 61
      Top = 87
      Width = 179
      Height = 23
      Caption = 'pnlasoapepatdni'
      TabOrder = 3
      object measoapepatdni: TMaskEdit
        Left = 1
        Top = 1
        Width = 176
        Height = 21
    ...
    object pnlasoapematdni: TPanel
      Left = 248
      Top = 87
      Width = 179
      Height = 23
      Caption = 'pnlasoapematdni'
      TabOrder = 4
      object measoapematdni: TMaskEdit
        Left = 1
        Top = 1
        Width = 176
        Height = 21
    ...
    object pnlasonomdni: TPanel
      Left = 435
      Top = 87
      Width = 179
      Height = 23
      Caption = 'pnlasonomdni'
      TabOrder = 5
      object measonomdni: TMaskEdit
        Left = 1
        Top = 1
        Width = 176
        Height = 21
  ...
  object gbdatlib: TGroupBox
    Left = 5
    Top = 264
    Width = 631
    Height = 118
    Caption = ' Datos de la libreta '
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Comic Sans MS'
    ...
    object dblcdbancoid: TwwDBLookupComboDlg
      ...
      ShowButton = True
      AllowClearKey = False
      OnChange = dblcdbancoidChange
      OnExit = dblcdbancoidExit
    end
    object meccbcoid: TMaskEdit
      Left = 239
      Top = 35
      Width = 128
      Height = 23
      ...
      Enabled = False
      EditMask = '000\-00000000\-0\-00;0;_'
      MaxLength = 17
      TabOrder = 1
    end
    ...
    object dbdtpfecent: TwwDBDateTimePicker
      Left = 228
      Top = 88
      Width = 94
      Height = 23
    ...
    object dbdtpfecenv: TwwDBDateTimePicker
      Left = 337
      Top = 88
      Width = 94
      Height = 23
    ...
    object dbdtpfecdep: TwwDBDateTimePicker
      Left = 121
      Top = 87
      Width = 94
      Height = 23
    ...
    object memontodol: TMaskEdit
      ...
      MaxLength = 7
      TabOrder = 7
      OnKeyPress = memontodolKeyPress
    end
  end
  object gbdattut: TGroupBox
    Left = 5
    Top = 151
    Width = 631
    Height = 112
    ...
    object dblcdproid: TwwDBLookupComboDlg
      Left = 200
      Top = 78
      Width = 55
      Height = 23
      ...
      ShowButton = True
      AllowClearKey = False
      OnChange = dblcdproidChange
      OnExit = dblcdproidExit
    end
    object dblcddisid: TwwDBLookupComboDlg
      Left = 405
      Top = 78
      Width = 62
      Height = 23
      ...
      ShowButton = True
      AllowClearKey = False
      OnChange = dblcddisidChange
      OnExit = dblcddisidExit
    end
    object pnlapenomtut: TPanel
      Left = 8
      Top = 36
      Width = 225
      Height = 23
      Caption = 'pnlapenomtut'
      TabOrder = 5
      object meapenomtut: TMaskEdit
        Left = 1
        Top = 1
        Width = 223
        Height = 21
  ...
  object gbdatrep: TGroupBox
    ...
    object dblcddptoidrep: TwwDBLookupComboDlg
      Left = 8
      Top = 87
      Width = 43
      Height = 23
      ...
      ShowButton = True
      AllowClearKey = False
      OnChange = dblcddptoidrepChange
      OnExit = dblcddptoidrepExit
    end
    object dblcdprovidrep: TwwDBLookupComboDlg
      Left = 200
      Top = 87
      Width = 55
      Height = 23
      ...
      ShowButton = True
      AllowClearKey = False
      OnChange = dblcdprovidrepChange
      OnExit = dblcdprovidrepExit
    end
    object dblcddistidrep: TwwDBLookupComboDlg
      Left = 405
      Top = 85
      Width = 62
      Height = 23
      ...
      ShowButton = True
      AllowClearKey = False
      OnChange = dblcddistidrepChange
      OnExit = dblcddistidrepExit
    end
    object dblcdrepid: TwwDBLookupComboDlg
      Left = 8
      Top = 41
      Width = 57
      Height = 23
      ...
      ShowButton = True
      AllowClearKey = False
      OnChange = dblcdrepidChange
      OnExit = dblcdrepidExit
    end
    object pnldesrep: TPanel
      Left = 72
      Top = 40
      Width = 275
      Height = 23
  ...
  object ppdbConsEntrega: TppDBPipeline
    DataSource = DM1.dsReporte
    UserName = 'dbConsEntrega'
    Left = 564
    Top = 427
  end
  object ppRepConsEntrega: TppReport
    ...
    Template.FileName = 
      'C:\Documents and Settings\irevilla\Escritorio\Constancia Entrega' +
      '.rtm'
    Units = utMillimeters
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object pplblTitulo: TppLabel
        UserName = 'lblTitulo'
        Caption = 
          'CONSTANCIA DE APERTURA Y DEPOSITO DE CUENTA DE AHORROS N'#176' 888888' +
          '8'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
      ...
      object ppLabel20: TppLabel
        UserName = 'Label20'
        Caption = 'DATOS DEL DEUDO (MENOR DE EDAD)'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 17cpi'
        Font.Size = 9
    ...
    object ppDetailBand1: TppDetailBand
      ...
      object pplblTipoCambio: TppLabel
        UserName = 'Label47'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 17cpi'
      ...
      object pplapenommen: TppLabel
        UserName = 'Label81'
        Caption = 'XXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXX'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 9
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      object ppLabel43: TppLabel
        UserName = 'Label33'
        Caption = 
          '       Mediante la presente hacemos de conocimiento que nuestra ' +
          'Instituci'#243'n ha realizado la apertura de la Cuenta de Ahorros y '
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 17cpi'
        Font.Size = 9
      ...
      object ppLabel78: TppLabel
        UserName = 'Label60'
        Caption = 'Firma del Tutor (Recepci'#243'n)'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 17cpi'
        Font.Size = 9
      ...
      object pplregistradopor: TppLabel
        UserName = 'pplregistradopor'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 17cpi'
        Font.Size = 9
      ...
      object ppLabel3: TppLabel
        UserName = 'Label3'
        Caption = 'deposito del beneficio en la cuenta del menor antes indicadas.'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 17cpi'
        Font.Size = 9
      ...
      object ppLabel4: TppLabel
        UserName = 'Label4'
        Caption = 
          '       Asimismo debemos indicarle que usted como padre o tutor d' +
          'eber'#225' recoger la tarjeta "Saldomatico"  en cualquier agencia a'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 17cpi'
        Font.Size = 9
      ...
      object ppLabel5: TppLabel
        UserName = 'Label5'
        Caption = ' nivel nacional del Banco de Cr'#233'dito del Per'#250'.'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 17cpi'
        Font.Size = 9
      ...
      object ppLabel6: TppLabel
        UserName = 'Label6'
        Caption = 'Sin otro en particular.'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 17cpi'
        Font.Size = 9
