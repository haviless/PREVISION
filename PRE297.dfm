object Fasoxedadysexo: TFasoxedadysexo
  Left = 498
  Top = 249
  ...
  object dbgdoxedadysexo: TwwDBGrid
    Left = 2
    Top = 81
    Width = 351
    Height = 292
    ...
    TitleLines = 2
    TitleButtons = False
    OnDblClick = dbgdoxedadysexoDblClick
  end
  ...
  object pprresedadxsexo: TppReport
    AutoStop = False
    DataPipeline = ppdbasoxedadysexo
    ...
    Version = '7.02'
    mmColumnWidth = 0
    DataPipelineName = 'ppdbasoxedadysexo'
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppltitdpt01: TppLabel
        UserName = 'Label21'
        Caption = 'RESUMEN DE ASOCIADOS DOCENTE POR  EDAD Y SEXO'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLabel4: TppLabel
        UserName = 'Label5'
        Caption = 'Cantidad docentes femenino'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
      ...
      object ppLabel7: TppLabel
        UserName = 'Label8'
        Caption = 'Cantidad docentes masculino'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 8
  ...
  object ppdbasoxedadysexo: TppDBPipeline
    DataSource = DM1.dsReporte
    UserName = 'dbp'
    Left = 1
    Top = 381
