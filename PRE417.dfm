object FRptPagBenDet: TFRptPagBenDet
  Left = 323
  Top = 178
  ...
  object dbgBeneficios: TwwDBGrid
    ...
    TitleLines = 2
    TitleButtons = True
    OnTitleButtonClick = dbgBeneficiosTitleButtonClick
  ...
  object ppDBConexion: TppDBPipeline
    DataSource = DM1.dsQry6
    UserName = 'DBConexion'
    Left = 388
    Top = 416
  end
  object ppPrevio: TppReport
    AutoStop = False
    DataPipeline = ppDBConexion
    ...
    Template.FileName = 
      'D:\Proyectos\Prevision\Documentos\2011000035\SRC_201107_PRE\RptP' +
      'agBenDet.rtm'
    DeviceType = 'Screen'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLblTitulo: TppLabel
        UserName = 'Label12'
        AutoSize = False
        Caption = 'PAGO DE BENEFICIOS POR PERIODO Y DPTO/UGEL'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
  ...
  object ppDesignerRun: TppDesigner
