object FManReclamos: TFManReclamos
  Left = 40
  Top = 145
  BorderStyle = bsDialog
  Caption = 'Mantenimiento de Reclamos'
  ClientHeight = 469
  ClientWidth = 775
  Color = 10207162
  ...
  object dbgReclamos: TwwDBGrid
    ...
    object dbgReclamosIButton: TwwIButton
      Left = 0
      Top = 0
      Width = 33
      Height = 33
      ...
      Glyph.Data = {
        ...
        3000333333333333377733333333333333333333333333333333}
      NumGlyphs = 2
      OnClick = dbgReclamosIButtonClick
    end
  end
  object PnlAnadeReclamo: TPanel
    Left = 156
    Top = 112
    Width = 533
    Height = 225
    ...
    object dbeRecDni: TwwDBEdit
      ...
      WantReturns = False
      WordWrap = False
      OnExit = dbeRecDniExit
    end
    object dbeRecApeNom: TwwDBEdit
      Left = 130
      Top = 56
      Width = 297
      Height = 23
    ...
    object dblcdTipDecIde: TwwDBLookupComboDlg
      Left = 130
      Top = 80
      Width = 55
      Height = 23
  ...
  object pnlResReclamo: TPanel
    ...
    object Label8: TLabel
      ...
      Height = 23
      AutoSize = False
      Caption = 'Usuario que recepciono :'
      Font.Charset = ANSI_CHARSET
      Font.Color = clNavy
      Font.Height = -11
      Font.Name = 'Comic Sans MS'
    ...
    object Label11: TLabel
      ...
      Height = 23
      AutoSize = False
      Caption = 'Fecha de Conclusi'#243'n:'
      Font.Charset = ANSI_CHARSET
      Font.Color = clNavy
      Font.Height = -11
      Font.Name = 'Comic Sans MS'
    ...
    object dbddtpConclusion: TwwDBDateTimePicker
      Left = 141
      Top = 176
      Width = 100
      Height = 23
    ...
    object dblcdConclusion: TwwDBLookupComboDlg
      Left = 141
      Top = 152
      Width = 52
      Height = 23
      ...
      MaxHeight = 209
      Selected.Strings = (
        'ID_TIPCON'#9'3'#9'Ide'#9'F'
        'DES_TIPCON'#9'40'#9'Descripci'#243'n'#9'F')
      ...
      ShowButton = True
      AllowClearKey = False
      OnExit = dblcdConclusionExit
    end
    object memConclusion: TMemo
      Left = 141
      Top = 200
      Width = 388
      Height = 65
  ...
  object pnlSeguimiento: TPanel
    ...
    object gbDetalle: TGroupBox
      ...
      Width = 463
      Height = 123
      Caption = ' Mantenimiento del Detalle '
      TabOrder = 2
  ...
  object btncierracheque: TBitBtn
    Left = 700
    Top = 433
    Width = 73
    Height = 30
  ...
  object bdeReportes: TppBDEPipeline
    DataSource = DM1.dsQry10
    UserName = 'bdeReportes'
    Left = 105
    Top = 435
  end
  object pprRecRec: TppReport
    AutoStop = False
    DataPipeline = bdeReportes
    ...
    object ppHeaderBand2: TppHeaderBand
      ...
      object ppLabel24: TppLabel
        UserName = 'Label24'
        Caption = 'NUMERO DE RECLAMOS RECIBIDOS SEGUN FECHA DE RECLAMO'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppFechas: TppLabel
        UserName = 'Fechas'
        Caption = 'DEL 01/01/2004 AL 30/08/2004'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
  ...
  object pprRecPen: TppReport
    ...
    PrinterSetup.mmPaperWidth = 210079
    PrinterSetup.PaperSize = 9
    Template.FileName = 'C:\Documents and Settings\irevilla\Escritorio\r2.rtm'
    DeviceType = 'Screen'
    OutlineSettings.CreateNode = True
    OutlineSettings.CreatePageNodes = True
    OutlineSettings.Enabled = False
    ...
    object ppHeaderBand3: TppHeaderBand
      ...
      object ppLabel38: TppLabel
        UserName = 'Label38'
        Caption = 'NUMERO DE RECLAMOS PENDIENTES SEGUN FECHA DE RECLAMO'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
  ...
  object pprRecCon: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel2: TppLabel
        UserName = 'Label2'
        Caption = 'NUMERO DE RECLAMOS CONCLUIDOS SEGUN FECHA DE CONCLUSION'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLabel8: TppLabel
        UserName = 'Label8'
        Caption = 'Reclamo concluido en contra del Usuario'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
  ...
  object bdepTipRec: TppBDEPipeline
    DataSource = DM1.dsQry2
    UserName = 'bdepTipRec'
    Left = 137
    Top = 435
  end
  object pprrecsd: TppReport
    AutoStop = False
    DataPipeline = bdeReportes
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    ...
    object ppHeaderBand4: TppHeaderBand
      ...
      object ppltitulofecha: TppLabel
        UserName = 'Fechas'
        Caption = 'DEL 01/01/2004 AL 30/08/2004'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object ppLabel42: TppLabel
        UserName = 'Label42'
        Caption = 'No se ha encontrado informaci'#243'n'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLabel43: TppLabel
        UserName = 'Label43'
        Caption = 'para este tipo de reporte'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
