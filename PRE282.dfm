object Frepxtipbenxocu: TFrepxtipbenxocu
  Left = 171
  Top = 224
  BorderStyle = bsDialog
  Caption = 'Estadistica por ocurrencia de beneficio'
  ClientHeight = 415
  ClientWidth = 689
  Color = 10207162
  ...
  object GroupBox1: TGroupBox
    ...
    Width = 307
    Height = 81
    Caption = ' Fecha de generaci'#243'n del expediente de liquidaci'#243'n '
    Color = 10207162
  ...
  object ppdbpocuben: TppDBPipeline
    DataSource = DM1.dsReporte
    UserName = 'dbp'
    Left = 320
    Top = 40
  end
  object pprbenocu: TppReport
    AutoStop = False
    DataPipeline = ppdbpocuben
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppltitdpt01: TppLabel
        UserName = 'Label21'
        Caption = 'BENEFICIOS ATENDIDOS POR A'#209'O DE OCURRENCIA'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
