object FBuscaLiqBeneficios: TFBuscaLiqBeneficios
  Left = 323
  Top = 243
  BorderStyle = bsDialog
  Caption = 'Liquidaciones de Beneficios'
  ClientHeight = 365
  ClientWidth = 792
  Color = 10207162
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object dbgLiquidacionBeneficios: TwwDBGrid
    Left = 8
    Top = 96
    Width = 777
    Height = 223
    ...
    TitleLines = 2
    TitleButtons = False
    OnDblClick = dbgLiquidacionBeneficiosDblClick
    object dbgExpLiquidacionIButton: TwwIButton
      Left = 0
      Top = 0
      Width = 29
      Height = 29
      ...
      NumGlyphs = 2
      OnClick = dbgExpLiquidacionIButtonClick
    end
  end
